...
public class Project {
    ...
    public Project(User assigned_project_manager_id, Timestamp created, String description, Date end_date, Integer id, String project_name, Date start_date, String status, Timestamp updated) {
...
//
    ...
    // Automatically set the updated timestamp before updating
    @PreUpdate
