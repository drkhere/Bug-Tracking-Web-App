...
import { ManagerService, bug } from '../../../manager.service';

@Component({
  selector: 'app-mainreportpagetester',
  ...
  templateUrl: './mainreportpagetester.component.html',
  styleUrl: './mainreportpagetester.component.css'
})
export class MainreportpagetesterComponent {
